...
const nutritionix = {
    ...
    exercise: {
        search: async function(query) {
            return request.ajax("POST", `${nutritionix.base_url}natural/exercise`, { query: query}, nutritionix.header).then(result => {
    ...
    natural: {
        search: async function (query) {
            return request.ajax("POST", `${nutritionix.base_url}natural/nutrients`, {
                query: query
            }, nutritionix.header).then(result => {
                return result.response;
            }).catch(error => {
                return {
                    error: error.error
